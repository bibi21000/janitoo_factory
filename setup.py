...
janitoo_entry_points = {
    ...
    "janitoo.values": [
        ...
        "sensor_wind_average = janitoo_factory.values.sensor:make_sensor_wind_average",
        "sensor_wind_gust = janitoo_factory.values.sensor:make_sensor_wind_gust",
        ...
        "network_controller = janitoo_factory.values.basic:make_network_controller",
    ],
}
